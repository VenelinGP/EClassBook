    ...
    public partial class MyFirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HeadmasterId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AddressId = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    RoleId = table.Column<int>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Headmasters", x => x.HeadmasterId);
                    table.ForeignKey(
                        name: "FK_Headmasters_Address_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Address",
                        principalColumn: "AddressId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Headmasters_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Headmasters_AddressId",
                table: "Headmasters",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Headmasters_RoleId",
                table: "Headmasters",
                column: "RoleId");
